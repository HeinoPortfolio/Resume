...
### 🔍 Quick Navigation: Featured Repositories
Since I maintain over 20+ repositories, here is a guide to my most significant work by category:


| Category | Top Project | Primary Tech Stack |
| :--- | :--- | :--- |
| 🤖 **Mobile Dev** | [Student Term Manager](https://github.com/HeinoPortfolio/AndroidProject) | Java, Android SDK, SQLite/Room |
| 🌐  **Full-Stack** | [Recipe Management](https://github.com/HeinoPortfolio/Milestone-3/tree/main) | MongoDB, Express, React, Node |
| 📊 **Data Science** | [Pattern Discovery](https://github.com/HeinoPortfolio/MS_Comp_Sci/tree/main/6%20Data%20Mining%20and%20Machine%20Learning ) | Python, scikit-learn, Pandas |
| ⚙️ **Systems / C#** | [Savings Tracker](https://github.com/HeinoPortfolio/CS690-FinalProject) | C#, .NET, Spectre Console |
| 🎓 **Academic** | [MSCS Core Work](https://github.com/HeinoPortfolio) | Java, C++, Algorithms, etc. |
...
🔗 [View Repository](https://github.com/HeinoPortfolio/CS690-FinalProject)
...
🔗 [View Repository](https://github.com/HeinoPortfolio/Milestone-3/tree/main )
...
🔗 [View Repository](https://github.com/HeinoPortfolio/CPlusPlus)
...
🔗 [View Repository](https://github.com/HeinoPortfolio/AndroidProject)
...
>   **CIW User Interface Design Certified:** Expert in interaction-focused UI/UX principles. <br><br>
>   **Agile Project Lead:** Spearheaded Scrum-based development for e-commerce and healthcare cases. <br><br>
>   **Strategic Influence:** Mastered leadership soft skills to guide cross-functional teams.
...
> * **Multiple Master’s** – One in  Data Analytics and one in IT Management
...
>  **Honors:** Summa Cum Laude (GPA: 3.976) | Dean’s List all eligible semesters. <br>
